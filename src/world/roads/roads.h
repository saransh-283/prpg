...
// New API: generate road polylines for a chunk/region in world coordinates.
// Returns a vector of polylines; each polyline is a vector of 2D points (x,z) in world space.
std::vector<std::vector<glm::vec2>> generate_perlin_roads_chunk_polylines(int chunk_x,
                                                                          int chunk_y,
                                                                          int chunk_size = 256,
                                                                          int padding = 64,
                                                                          int num_worms = 200,
